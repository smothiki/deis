...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'App.type'
        db.add_column(u'api_app', 'type',
                      self.gf('django.db.models.fields.CharField')(default=u'buildpack', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'App.type'
        db.delete_column(u'api_app', 'type')
    ...
    models = {
        u'api.app': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'proper-jokester'", 'unique': 'True', 'max_length': '64'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'structure': ('json_field.fields.JSONField', [], {'default': '{}', 'blank': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "u'buildpack'", 'max_length': '128'}),
